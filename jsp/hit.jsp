...
<p style="text-align: center; color: white">
    ...
    <div class="div_form">
    	...
    	<input type="submit" value="ダブル" class="button_disabled" disabled>
    	</form>
    	<form action="/bj/Surrender" method="post">
    	<input type="submit" value="サレンダー" class="button_disabled" disabled>
    	</form>
    </div>
